...
import com.example.anuj.echo.adapters.FavoriteAdapter
import com.example.anuj.echo.databases.EchoDatabase
import kotlinx.android.synthetic.main.fragment_favouritefragment.*
...
class Favouritefragment : Fragment() {
   ...
   // var getSongsList: ArrayList<Songs>? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
      ...
      val view = inflater!!.inflate(R.layout.fragment_favouritefragment,container,false)
    ...
    fun bottomBarClickHandler(){
        nowPlayingBottomBar?.setOnClickListener({
            ...
            fragmentManager?.beginTransaction()
                    ?.replace(R.id.deatils_fragment,songPlayingFragment)
